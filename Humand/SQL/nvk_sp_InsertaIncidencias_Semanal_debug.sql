CREATE or alter PROC dbo.nvk_sp_InsertaIncidencias_Semanal_debug
    @Empresa    char(5),
...
BEGIN
  ...
  --      FROM Humand
   ...
   GROUP BY b.Departamento,b.SucursalTrabajo,b.Categoria,b.Personal, b.PeriodoTipo, b.Empresa, a.Fecha
    ...
    INTO #Detalle
    FROM #Incidencias
	UNPIVOT (Valor FOR TipoIncidencia IN (RetardoMenorEntrada, RetardoMenorComida, RetardoMayorEntrada,RetardoMayorComida,/*SalidasAnticipadas,*/Falta,PermisoHoras,PermisoDefuncionFamDirecto,PermisoDefuncionFamIndirecto,PermisoPaternidad,TiempoPorTiempoHoras
,Vacaciones,IncapacidadEnfermedad,IncapacidadAccidente/*,RevisarHorario*/)) AS u
	...
	select * from #Detalle where TipoIncidencia ='RetardoMayorEntrada'
    ...
    BEGIN
        ...
        -- RetardoMayorEntrada no genera movimiento de nómina ni su encabezado.
