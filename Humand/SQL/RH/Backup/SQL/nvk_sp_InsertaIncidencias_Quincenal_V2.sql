...
BEGIN
    ...
    SELECT
		...
		b.Departamento,
		b.SucursalTrabajo,
        -- Retardos menores/mayores: solo NO sindicalizados (los sindicalizados van a UnidadesSindicalizado)
		...
		-- Sindicalizados: 1 unidad por cada 10 min (o fraccion) despues de la tolerancia, en ENTRADA y REGRESO_COMIDA
    ...
    BEGIN
        ...
        BEGIN
            ...
            SELECT
				...
				CASE WHEN @AcumulaPeriodo = 1 THEN 'Quincena ' + @PeriodoValor ELSE CONVERT(varchar(50), d.Fecha) END,
                @Fecha,
                1, 0, 0
            FROM #Detalle d
            JOIN #Periodos p ON p.PeriodoTipo = d.PeriodoTipo
